...
function auditGeminiAPI(
  ...
  if (useCase === "coding" || useCase === "data") {
    return {
      ...
      recommendedAction: `Switch to Anthropic API or OpenAI API`,
  ...
  if (monthlySpend > CREDITS_THRESHOLD) {
    return {
      ...
      recommendedAction: "Get Gemini API through Credex discounted credits",
  ...
  return {
    ...
    estimatedMonthlySavings: 0,
    reason:
      "Your Gemini API setup looks right-sized for your team and use case."
  };
}

export default auditGeminiAPI;
